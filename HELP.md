...
* The original package name 'InsuranceApp.mapersive.com .' is invalid and this project uses 'InsuranceApp.mapersive.com' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.0.10/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
